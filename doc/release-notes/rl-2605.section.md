...
- The default NVIDIA drivers no longer support Maxwell (GTX 1xxx) or older GPUs. Pin the nvidia package to ` config.boot.kernel.packages.nvidiaPackages.legacy_580` for continued support.
