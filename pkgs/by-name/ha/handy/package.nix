...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-S1dJ9HYEoF21WxHAZ0YpJ5NRkI32Y3s1GzEG4KtwUqY=";
  };

  cargoRoot = "src-tauri";
  cargoHash = "sha256-L6CJcYq1QC3TcimIhqsVg9NZqXBl04JLz1Vc7POSZ+I=";
  ...
  passthru = {
    ...
    frontendDeps = stdenvNoCC.mkDerivation {
      ...
      outputHash = "sha256-s7hyxVhMQeF3ir1ngyKj3nKhqh/Aoh+1Kc18+ygt6mA=";
